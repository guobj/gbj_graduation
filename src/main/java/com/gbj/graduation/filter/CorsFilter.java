package com.gbj.graduation.filter;

import com.gbj.graduation.controller.TestController;
import com.gbj.graduation.utils.CollectionUtil;
import com.gbj.graduation.utils.StringUtil;
...
public class CorsFilter implements Filter {
	...
	public void doFilter(ServletRequest req, ServletResponse res,
		...
		if (StringUtil.isNotEmpty(allowOrigin)) {
			...
			log.debug("allowOriginList : " + allowOriginList);
