...
import com.gbj.graduation.utils.JacksonData;
...
//ceas
	...
	@ResponseBody
	public JacksonData test(@RequestBody(required = false) Employee employee){

		return new JacksonData().success(employee);
	}
}
